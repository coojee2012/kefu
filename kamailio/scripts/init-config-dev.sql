...
*/
INSERT INTO `dispatcher` (`id`,`setid`,`destination`,`flags`,`priority`,`attrs`,`description`) VALUES (1,1,'sip:192.168.2.220:5090',0,0,'weight=50','FreeSWITCH-1');
INSERT INTO `dispatcher` (`id`,`setid`,`destination`,`flags`,`priority`,`attrs`,`description`) VALUES (2,2,'sip:192.168.2.220:5090',0,0,'','conference-server-1');
...
*/
INSERT INTO `address` (`id`,`grp`,`ip_addr`,`mask`,`port`,`tag`) VALUES (1,1,'192.168.2.220',32,5090,'udp');
INSERT INTO `address` (`id`,`grp`,`ip_addr`,`mask`,`port`,`tag`) VALUES (2,1,'192.168.2.220',32,5092,'udp');
...
INSERT INTO `address` (`id`,`grp`,`ip_addr`,`mask`,`port`,`tag`) VALUES (6,3,'192.168.2.220',32,5092,'call-ctrl');
